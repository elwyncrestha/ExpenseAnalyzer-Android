...
public interface CategoryService {
    ...
    @GET(CategoryService.URL + "/list?page={page}&size={size}")
    Call<ResponseDto<PageableDto<Category>>> getPageable(@Header("Authorization") String token, @Path("page") Integer page, @Path("size") Integer size);
